    <nav class="navbar navbar-expand-lg navbar-dark py-lg-3">
        <div class="container">
            <!-- Navbar Logo Start-->
            <a class="navbar-brand " href="{{ \URL::to('/') }}"> <img src="{{ asset('img/logo-baru.png') }}"
                    alt="logo sipetek" height="80" /> </a>
            <!-- Navbar Logo End -->
                ...
                <ul class="navbar-nav ms-auto">
                    @auth
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-capitalize active" href="#" id="navbarDropdown"
                                role="button" data-bs-toggle="dropdown" aria-expanded="false"> Halo,
                                {{ Auth::user()->name }} <i class="mdi mdi-heart text-danger ms-1"></i></a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li>
                                    @if (Auth::user()->role == 1)
                                        <a class="dropdown-item" href="{{ route('admin.dashboard') }}"><i
                                                class="mdi mdi-home-variant-outline me-1"></i> My Dashboard</a>
                                    @else
                                        <a class="dropdown-item" href="{{ route('user.profile') }}"><i
                                                class="mdi mdi-account-circle me-1"></i> My Account</a>
                                    @endif
                                </li>
                                <li>
