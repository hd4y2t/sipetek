                ...
                <div class="col-lg-12">
                    <div class="text-center">
                        ...
                        <p class="text-muted mt-2">The clean and well commented code allows easy customization of the
                            theme.It's designed for <br />describing your app, agency or business.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-3">
                <div class="col-lg-4">
                    <div class="text-center icon-box p-3">
                        ...
                        <p class="text-muted mt-2 mb-0">Et harum quidem rerum as expedita distinctio nam libero tempore cum
                            soluta nobis est cumque quo.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="text-center icon-box p-3">
                        ...
                        <p class="text-muted mt-2 mb-0">Temporibus autem quibusdam et aut officiis necessitatibus saepe
                            eveniet ut sit et recusandae.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="text-center icon-box p-3">
                        ...
                        <p class="text-muted mt-2 mb-0">Nam libero tempore, cum soluta a est eligendi minus id quod maxime
                            placeate facere assumenda est.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-3 pt-4">
                ...
                <div class="col-lg-4">
                    <div class="icon-box p-3">
                        ...
                        <p class="text-muted mt-2 mb-0">Voluptatum deleniti atque corrupti quos dolores et quas molestias
                            excepturi.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="text-center">
                        ...
                        <p class="text-muted mt-2">Here are some of the basic types of questions for our customers. For
                            more <br />information please contact us.</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingOne">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    ...
                                    <i class="bx bxs-help-circle text-danger me-1"></i> Kenapa saya tidak bisa melakukan
                                    login?
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingThree">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <i class="bx bxs-help-circle text-danger me-1"></i> Kenapa pengaduan saya tidak di
                                    proses
                                </button>
                            </h2>
                ...
                <div class="col-lg-12">
                    <div class="text-center">
                        ...
                        <p class="text-muted mt-2">Please fill out the following form and we will get back to you shortly.
                            For more <br />information please contact us.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-lg-4">
                            <div class="text-center icon-box p-3">
                                ...
                                <p class="text-muted mt-2 mb-0">Jl. Mayjen Sutoyo Siswomiharjo <br />No.48 Subang - Jawa
                                    Barat 41211</p>
                            </div>
                        </div>
                        <div class="col-lg-4">
