...
@endsection
@section('title', 'Detail Mobil Jenazah | SIPADU')
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <div>
                                        <h4 class="mt-1 mb-1 text-white">{{ $mobil->nomor }}</h4>
                                        <p class="font-13 text-white-50">{{ $mobil->kontak }}</p>
                        ...
                        <div class="col-sm-4">
                            <div class="text-center mt-sm-0 mt-3 text-sm-end">
                                <a href="admin/perizinan/{{ $mobil->id }}/edit" type="button" class="btn btn-light"><i
                                        class="mdi mdi-pencil me-1"></i> Edit</a>
                                <form action="admin/perizinan/{{ $mobil->id }}" method="POST" class="d-inline">
                                    @method('delete')
                                    @csrf
