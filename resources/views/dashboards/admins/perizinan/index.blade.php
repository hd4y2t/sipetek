...
@endsection
@section('title', 'Data Perizinan | SIPADU')
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Tabel Data Perizinan</h4>
                    <p class="text-muted font-14">Lorem, ipsum dolor sit amet <code>&lt;consectetur&gt;</code> adipisicing
                        elit. Voluptate, accusamus!</p>
                    <a href="{{ url('admin/perizinan/create') }}" class="btn btn-danger mb-3"><i class="mdi mdi-plus"></i>
                        Tambah Perizinan</a>
