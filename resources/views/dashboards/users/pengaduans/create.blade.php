                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ url('pengaduans') }}" class="btn btn-primary mb-3"><i class="mdi mdi-eye"></i> Lihat
                                Pengaduan</a>
                            <!-- Tab Content -->
                            <div class="tab-content">
                                <form action="{{ route('pengaduans.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('perihal_id') is-invalid @enderror"
                                                    name="perihal_id">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('subjek') }}" required autofocus />
                                                @error('subjek')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                        ...
                                        placeholder="Masukkan slug" value="{{ old('slug') }}" required />
                                    ...
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-success mt-2"><i
                                                class="mdi mdi-email-send-outline"></i> Kirim Pengaduan</button>
                                    </div>
                                </form>
                            </div>
                            <!-- End Tab Content -->
